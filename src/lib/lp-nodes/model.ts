...
export const SECTION_SPECS: Record<SectionType, SectionSpec> = {
  ...
  band: {
    ...
    props: [
      ...
      { key: 'width', label: 'Width', kind: 'select', options: [{ id: 'full', label: 'Full' }, { id: 'narrow', label: 'Narrow' }] },
      { key: 'flat', label: 'Cards without a border', kind: 'select', options: [{ id: 'no', label: 'No' }, { id: 'yes', label: 'Yes' }] },
      { key: 'numbered', label: 'Number the steps', kind: 'select', options: [{ id: 'no', label: 'No' }, { id: 'yes', label: 'Yes' }] },
    ],
